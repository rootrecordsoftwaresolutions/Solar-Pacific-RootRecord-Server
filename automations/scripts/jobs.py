...
TOGGLES = [
    ...
    {"id": "delta2_ac_charging", "device": "delta2", "function": "AC charging", "on": "delta2-ac-charging-on.sh",
     ...
     "status": "PASS 2026-09-23 (chg4): ON readback=True (chg_pause_flag==0), OFF readback=True (chg_pause_flag==1); enabled=True->charging on, enabled=False->charging off, matches wrapper names directly, no ambiguity",
    ...
    {"id": "river2pro_ac_always_on", "device": "river2pro", "function": "AC always-on", "on": "river2pro-ac-always-on-on.sh",
     ...
     "verify": "unknown (readback field name unverified)", "note": ""},
