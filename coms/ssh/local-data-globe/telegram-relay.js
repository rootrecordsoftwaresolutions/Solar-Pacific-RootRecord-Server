 ...
 *
 * Config (env):
 *   TELEGRAM_RELAY_CHAT_ID   - required to actually send; channel/chat id
 *                              for "Root Record Data Relay" (or wherever
 *                              you want this routed -- keep it separate
 *                              from RR_CONTROL_CHAT_ID / RR_PUBLISH_CHAT_ID)
 ...
 *   AVA_TELEGRAM_BOT_TOKEN / TELEGRAM_BOT_TOKEN - bot token, loaded from
 *                              /home/rootrecord/master/master-key.env,
 *                              same convention as coms/telegram
 */
...
function start() {
  ...
  started = true;
  if (!CHAT_ID) {
    console.error('telegram-relay: TELEGRAM_RELAY_CHAT_ID not set — insurance relay is inert until configured');
  }
